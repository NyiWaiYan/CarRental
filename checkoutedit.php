...
$dropoffdate=$_POST['dropoffdate'];
   ...
   if($cart_total == 0){
      ...
      if(mysqli_num_rows($order_query) > 0){
        ...
        mysqli_query($connect,"INSERT INTO `booking`( `userId`, `name`, `bookcar`, `number`, `email`, `method`, `address`, `placed_on`, `pickupdate`, `dropoffdate`, `price`, `payment_status`) VALUES ('$userId','$name','$total_products','$number','$email','$method','$address','$placed_on','$pickupdate','$dropoffdate','$cart_total')");
...
<section class="checkout">
   ...
   <form action="" method="post">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>country :</span>
            <input type="text" name="addresss" required placeholder="Address">
         </div>
         <div class="inputBox">
            <span>PICK UP DATE:</span>
            <input type="text" name="pickupdate" required placeholder="D/M/Y">
         </div>

         <div class="inputBox">
            <span>DROP OFF DATE :</span>
            <input type="text" name="addresss" required placeholder="D/M/Y">
         </div>
